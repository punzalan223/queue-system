...
<div>
    <footer class="bg-white font-roboto">
        <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
            ...
            <a href="#" class="text-tsecondary font-medium hover:text-gray-900">Home</a>
            <a href="#" class="text-tsecondary font-medium hover:text-gray-900">About</a>
            <a href="#" class="text-tsecondary font-medium hover:text-gray-900">Solution</a>
            <a href="#" class="text-tsecondary font-medium hover:text-gray-900">Pricing</a>
            <a href="#" class="text-tsecondary font-medium hover:text-gray-900">Customers</a>
            <a href="#" class="text-tsecondary font-medium hover:text-gray-900">Contact</a>
            </nav>
