...
<div>
    <footer class="bg-white font-roboto">
        <div class="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
            <nav aria-label="Footer" class="-mb-6 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6">
            <a href="#" class="text-primary font-medium hover:text-gray-900">Home</a>
            <a href="#" class="text-primary font-medium hover:text-gray-900">About</a>
            <a href="#" class="text-primary font-medium hover:text-gray-900">Solution</a>
            <a href="#" class="text-primary font-medium hover:text-gray-900">Pricing</a>
            <a href="#" class="text-primary font-medium hover:text-gray-900">Customers</a>
            <a href="#" class="text-primary font-medium hover:text-gray-900">Contact</a>
            </nav>
            <div class="mt-16 flex justify-center gap-x-10">
            <a href="#" class="text-primary font-medium hover:text-gray-800">
            ...
            <a href="#" class="text-tsecondary font-medium hover:text-gray-800">
            ...
            <p class="mt-10 text-center text-tsecondary">&copy; 2024 Queueket, Inc. All rights reserved.</p>
        </div>
    </footer>
</div>
